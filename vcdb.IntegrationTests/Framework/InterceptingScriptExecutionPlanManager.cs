...
{
    public class InterceptingScriptExecutionPlanManager : IScriptExecutionPlanManager
    {
        ...
        {
            public override TableComponentName ReadJson(JsonReader reader, Type objectType, [AllowNull] TableComponentName existingValue, bool hasExistingValue, JsonSerializer serializer)
            {
                throw new NotSupportedException();
            }

            public override void WriteJson(JsonWriter writer, [AllowNull] TableComponentName value, JsonSerializer serializer)
            {
